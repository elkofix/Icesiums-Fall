...
class Solver:
    ...
    def find_solution(self, show_in_help=False):
        """Find escape solution"""
        callback = self.help_callback if show_in_help else self.add_output
    ...
    def find_solution_no(self, show_in_help=False):
        """Find escape solution"""
        callback = self.help_callback if show_in_help else self.add_output
    ...
    def find_solution_start(self, show_in_help=False):
        """Find escape solution"""
        callback = self.help_callback if show_in_help else self.add_output
