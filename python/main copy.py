...
class EscapeRoomGUI:
        ...
        try:
            ...
            for i in range(1, 34):
                ...
                if os.path.exists(img_path):
                    ...
                    max_height = SCREEN_HEIGHT - self.intro_image_margin_top - 300  # 50px para el texto de "saltar"
    ...
    def draw_intro(self):
        ...
        if not self.intro_completed and self.intro_images:
            ...
            skip_font = pygame.font.SysFont('Arial', 30)
            skip_text = skip_font.render("Presiona ESPACIO para saltar la intro", True, (255, 255, 255))
            text_rect = skip_text.get_rect(center=(SCREEN_WIDTH//2, SCREEN_HEIGHT - 30))
